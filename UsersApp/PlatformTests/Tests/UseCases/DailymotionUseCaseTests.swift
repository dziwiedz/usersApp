...
class DailymotionUseCaseTests: XCTestCase {
    
    var useCase: Platform.GetDailyMotionUsersCase!
    ...
    override func setUp() {
        ...
        self.webServiceMock.fileName = "DailyMotionUserResponse"
        self.useCase = GetDailyMotionUsersCase(resource: resource, webService: webServiceMock)
    }
    ...
    func testReturningValues() {
        ...
        var returendUsers: [DailyMotionUser]?
